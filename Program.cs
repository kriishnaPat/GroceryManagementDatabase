                ...
                Hyigene: 223");
                    ...
                    else if (user_choice == 3)
                    {
                        ...
                        for (int i = 0; i < items.Length; i++)
                        {
                            ...
                            {
                                Console.WriteLine($"{items[i]}Is this what you are looking for, press 1 for yes or 2 for no:");
                    ...
                    else if (user_choice == 4)
                    {
                        ...
                        for (int i = 0; i < 2; i++)
                        {
                            if (userChoice[0][1][i].Contains(remove) == true)
                            {
                                ...
                                if (yn == "1")
                                {
                                    userChoice[0][1].Remove(removeTrue);
                                    Console.WriteLine($"{removeTrue} has been added to your cart!");
                                }
                            }
                        }
                        string jsonString = JsonSerializer.Serialize(userChoice);
